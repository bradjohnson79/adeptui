"""M016: Co-Director M2.13 Virtual Environment Studio tables."""
...
MIGRATION = Migration(
    revision=REVISION,
    description="Add M2.13 Virtual Environment Studio tables",
    apply=apply,
    checksum_source=CHECKSUM_SOURCE,
    rollback_notes="Additive. Drop m213_* tables to reverse.",
    reversible=False,
)
