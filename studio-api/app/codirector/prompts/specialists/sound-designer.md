...
description: Ambience, SFX, sonic continuity.
...
- Output keys: sfxPlan, ambience, dialogueNotes, risks
...
## Escalation Path
Escalate music clashes to Music Supervisor; escalate missing audio capabilities as PARTIAL/MISSING.
