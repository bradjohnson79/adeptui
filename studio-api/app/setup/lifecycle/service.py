...
_COMPONENT_METADATA_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "videochat3_4b": {
        "group": "Co-Director",
        "subgroup": "Video Intelligence",
        "surfaceGroups": ["Co-Director", "Timeline"],
        "capabilityTags": ["video-understanding", "continuity", "timeline"],
        "badges": ["Essential", "Co-Director Continuity"],
        "bestFor": ["keep the next shot continuous", "see what actually happened"],
        "strengths": ["Timeline visual review", "3-second and 5-second continuity"],
        "weaknesses": ["Uses GPU after generation, then unloads"],
        "vramRecommendationGb": 8,
        "lifecycleActions": {"install": True, "repair": True, "calibrate": False, "certify": True},
        "surfaceEntryPoints": {"dock": True, "coDirector": True},
        "license": "Apache-2.0",
        "sourceRepo": "MCG-NJU/VideoChat3-4B",
    },
    "internvideo3_8b": {
        "group": "Co-Director",
        "subgroup": "Video Intelligence",
        "surfaceGroups": ["Co-Director", "Timeline"],
        "capabilityTags": ["video-understanding", "deep-review"],
        "badges": ["Advanced", "Hardware dependent"],
        "bestFor": ["longer sequence review"],
        "strengths": ["Deeper shot and sequence reasoning"],
        "weaknesses": ["Needs more GPU memory"],
        "vramRecommendationGb": 16,
        "lifecycleActions": {"install": True, "repair": True, "calibrate": False, "certify": False},
        "surfaceEntryPoints": {"dock": False, "coDirector": True},
        "license": "Apache-2.0",
        "sourceRepo": "yanziang/InternVideo3-8B-Instruct",
    },
    "grounding_dino_tiny": {
        "group": "Co-Director",
        ...
        "strengths": ["Open-vocabulary boxes"],
        "weaknesses": ["Optional. Windows GPU required. Not Ready."],
        "vramRecommendationGb": 6,
        "lifecycleActions": {"install": True, "repair": True, "calibrate": False, "certify": False},
        "license": "Apache-2.0",
        "sourceRepo": "IDEA-Research/grounding-dino-tiny",
        "experimental": True,
    },
    "sam21_hiera_tiny": {
        "group": "Co-Director",
        ...
        "strengths": ["Precise masks"],
        "weaknesses": ["Optional. Not a default mask yet."],
        "vramRecommendationGb": 4,
        "lifecycleActions": {"install": True, "repair": True, "calibrate": False, "certify": False},
        "license": "Apache-2.0",
        "sourceRepo": "facebook/sam2.1-hiera-tiny",
        "experimental": True,
    },
    "depth_anything_v2_small": {
        ...
        "strengths": ["Small Apache-2.0 depth"],
        "weaknesses": ["Relative only. Large/Base are not shipped."],
        "vramRecommendationGb": 2,
        "lifecycleActions": {"install": True, "repair": True, "calibrate": False, "certify": False},
        "license": "Apache-2.0",
