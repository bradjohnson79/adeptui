...
CAPABILITIES: tuple[CapabilityDefinition, ...] = (
    ...
    _d(
        ...
        subsystem="codirector",
        baseline_status=S.NOT_CONFIGURED,
        summary="Run M2.5 vision/continuity validation sessions (mock provider ready; local ML stubs inconclusive).",
        read_only=False,
        requires_approval=False,
        http_ref="POST /api/codirector/vision/validate",
        baseline_reason="Flag-gated; mock provider is deterministic; local ML adapters are stubbed as inconclusive.",
        scope="project",
    ),
    _d(
