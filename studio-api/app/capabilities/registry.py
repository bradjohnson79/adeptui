...
CAPABILITIES: tuple[CapabilityDefinition, ...] = (
    ...
    _d(
        ...
        baseline_status=S.LOCALLY_VERIFIED,
        summary="Structured Virtual Stage camera (flag-gated M2.8 fixture path).",
        read_only=False,
        http_ref="POST /api/codirector/m28/virtual-stage",
        baseline_reason="Flag-gated; fixture-capable structured camera persist/reload.",
        scope="project",
    ),
    _d(
    ...
    # ---------------------------------------------------------------- M2.13 virtual environment studio
    _d(
        id="ve.import.validate",
        display_name="3D import validation",
        subsystem="virtual_environment",
        baseline_status=S.PARTIALLY_WIRED,
        summary="Validate imported 3D assets (signature/size/script rejection).",
        read_only=True,
        http_ref="POST /api/codirector/m213/import",
        baseline_reason="Wired for GLB/common meshes; full authoring unsupported.",
    ),
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.NOT_IMPLEMENTED,
        summary="Blender CLI convert when binary detected; never silently installed.",
        read_only=False,
        baseline_reason="Requires local Blender; not a sculpt/rig/UV suite.",
    ),
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.PARTIALLY_WIRED,
        summary="Normalize/register imported environments with approval gate.",
        read_only=False,
        requires_approval=True,
        http_ref="POST /api/codirector/m213/import",
    ),
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.PARTIALLY_WIRED,
        summary="Detect/order/stitch camera-spin levels C1-C3 (fixture-capable).",
        read_only=False,
        requires_approval=True,
    ...
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.NOT_IMPLEMENTED,
        summary="Reconstruction adapters only if binaries detected; fixture for CI.",
        read_only=False,
        requires_approval=True,
        http_ref="POST /api/codirector/m213/reconstruction",
        baseline_reason="No silent COLMAP/Nerfstudio download; fixture adapter for CI.",
    ),
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.PARTIALLY_WIRED,
        summary="Persist/recommend/preview VisualThemeProfile.",
        read_only=False,
        requires_approval=True,
    ...
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.PARTIALLY_WIRED,
        summary="Four-channel character blocking with approval.",
        read_only=False,
        requires_approval=True,
    ...
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.PARTIALLY_WIRED,
        summary="Camera scene state (metadata; respects M2.10b execution locks).",
        read_only=False,
        requires_approval=True,
    ...
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.PARTIALLY_WIRED,
        summary="Key/fill/back lighting state + presets.",
        read_only=False,
        requires_approval=True,
        http_ref="POST /api/codirector/m213/scene-state",
    ),
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.PARTIALLY_WIRED,
        summary="Draft/Production/Final Candidate tiers; mock labeled in CI.",
        read_only=False,
        requires_approval=True,
        http_ref="POST /api/codirector/m213/concepts",
        baseline_reason="Mock/fixture default; real only when provider explicitly enabled.",
    ),
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.PARTIALLY_WIRED,
        summary="Publish concept packages to Director Timeline/editor handoff.",
        read_only=False,
    ...
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.PARTIALLY_WIRED,
        summary="SceneProductionPlan state machine with readiness and blockers.",
        read_only=False,
        requires_approval=True,
    ...
    _d(
        ...
        subsystem="virtual_environment",
        baseline_status=S.PARTIALLY_WIRED,
        summary="VPC specialist + coordination dashboard (advise-only tools).",
        read_only=True,
