...
- `docs/codirector/m2.9-readiness-remediation.md` (remediation tracker)
- `docs/codirector/m2.10-preflight-checkpoint-2.md` (Phase 0 inventory checkpoint; does not replace checkpoint 1)
