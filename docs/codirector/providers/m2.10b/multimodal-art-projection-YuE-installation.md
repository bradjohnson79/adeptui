# M2.10b Installation Report — `multimodal-art-projection/YuE`
...
| Field | Value |
| --- | --- |
| Registry ID | `m2101-music-048` |
| Source key | `multimodal-art-projection/YuE` |
| Capability | `audio.music.generate` |
| License (discovery) | `Apache-2.0` |
| Repository / model URL | `https://github.com/multimodal-art-projection/YuE` |
