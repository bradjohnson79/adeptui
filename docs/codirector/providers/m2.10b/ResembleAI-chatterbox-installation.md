# M2.10b Installation Report — `ResembleAI/chatterbox`
...
| Field | Value |
| --- | --- |
| Registry ID | `m2101-dialogue-003` |
| Source key | `ResembleAI/chatterbox` |
| Capability | `audio.dialogue.generate` |
| License (discovery) | `mit` |
| Repository / model URL | `https://huggingface.co/ResembleAI/chatterbox` |
