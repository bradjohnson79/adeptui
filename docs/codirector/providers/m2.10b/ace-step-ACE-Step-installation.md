# M2.10b Installation Report — `ace-step/ACE-Step`
...
| Field | Value |
| --- | --- |
| Registry ID | `m2101-music-045` |
| Source key | `ace-step/ACE-Step` |
| Capability | `audio.music.generate` |
| License (discovery) | `Apache-2.0` |
| Repository / model URL | `https://github.com/ace-step/ACE-Step` |
...
Music alternate; watch trust_remote_code / auto_map surfaces during install.
