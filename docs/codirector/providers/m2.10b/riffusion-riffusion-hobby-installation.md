# M2.10b Installation Report — `riffusion/riffusion-hobby`
...
| Field | Value |
| --- | --- |
| Registry ID | `m2101-music-049` |
| Source key | `riffusion/riffusion-hobby` |
| Capability | `audio.music.generate` |
| License (discovery) | `MIT` |
| Repository / model URL | `https://github.com/riffusion/riffusion-hobby` |
