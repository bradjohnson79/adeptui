# M2.10b Installation Report — `Stability-AI/stable-audio-tools`
...
| Field | Value |
| --- | --- |
| Registry ID | `m2101-sfx-021` |
| Source key | `Stability-AI/stable-audio-tools` |
| Capability | `audio.sfx.generate` |
| License (discovery) | `MIT` |
| Repository / model URL | `https://github.com/Stability-AI/stable-audio-tools` |
...
SFX fill-target (M2.10.2 Product scope).
