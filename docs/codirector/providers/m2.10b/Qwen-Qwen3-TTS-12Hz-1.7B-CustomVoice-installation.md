# M2.10b Installation Report — `Qwen/Qwen3-TTS-12Hz-1.7B-CustomVoice`
...
| Field | Value |
| --- | --- |
| Registry ID | `m2101-dialogue-002` |
| Source key | `Qwen/Qwen3-TTS-12Hz-1.7B-CustomVoice` |
| Capability | `audio.dialogue.generate` |
| License (discovery) | `apache-2.0` |
| Repository / model URL | `https://huggingface.co/Qwen/Qwen3-TTS-12Hz-1.7B-CustomVoice` |
...
Dialogue alternate; sandbox evaluation only until runtime results recorded.
