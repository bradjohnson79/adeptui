# M2.10b Installation Report — `hkchengrex/MMAudio`
...
| Field | Value |
| --- | --- |
| Registry ID | `m2101-sfx-031` |
| Source key | `hkchengrex/MMAudio` |
| Capability | `audio.sfx.generate` |
| License (discovery) | `MIT` |
| Repository / model URL | `https://github.com/hkchengrex/MMAudio` |
