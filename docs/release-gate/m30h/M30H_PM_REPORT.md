...
| Commercial | PASS |
| Dramatic | PASS |
| Dialogue-Free (orch) | PASS |
| Dialogue-Free (live) | BLOCKED_NO_LIVE_GENERATE / INCONCLUSIVE |
| Music Video | PASS |
| Multilingual | PASS |
| Revision | PASS |
| Recovery | PASS |
...
S3 live music-off is not GREEN (BLOCKED/INCONCLUSIVE) and/or an orchestration package failed. Per Hybrid rules there is no conditional YES.
