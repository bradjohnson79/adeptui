...
**Live evidence for Revision A polish:** [05-FINAL-POLISH.md](./05-FINAL-POLISH.md).  
**Prior program GO (historical for this polish):** [REVISION-A-UNIFIED-COMPLETION.md](./REVISION-A-UNIFIED-COMPLETION.md). [03-LIVE-CLOSURE.md](./03-LIVE-CLOSURE.md), [02-LIVE-CERTIFICATION.md](./02-LIVE-CERTIFICATION.md), and [01-IMPLEMENTATION-AND-CERTIFICATION.md](./01-IMPLEMENTATION-AND-CERTIFICATION.md) are historical.
