# M42 — HunyuanVideo 1.5 Provider Report

**Provider ID:** `hunyuan-video-1.5-local`  
**Stamped:** 2026-08-01T18:05:58.815357+00:00  
**Installed/healthy (this host):** False

## Scope

Independent install, remove, repair, verify, health, benchmark, and workflow keys for `hunyuan-video-1.5-local`.
...
- `artifacts/m42/hunyuan/hunyuan-video-1.5-local/`
