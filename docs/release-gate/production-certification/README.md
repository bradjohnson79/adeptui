...
| Field | Value |
|-------|-------|
| Certification phase | M3.0d — production gate closure |
...
| Document | Purpose |
|----------|---------|
| [M30D_MASTER_REMEDIATION_REGISTER.md](./M30D_MASTER_REMEDIATION_REGISTER.md) | Authoritative closure register for B5–B21, UJ, PY, PW, S01–S12 |
| [M30D_BACKEND_FINAL_GATE.md](./M30D_BACKEND_FINAL_GATE.md) | Full `pytest -q` gate: 631 passed / 0 failed / 6 skipped |
| [BACKEND_FAILURE_CLOSURE.md](./BACKEND_FAILURE_CLOSURE.md) | PY01–PY20 disposition and full-suite follow-up |
...
| [M30D_FAL_MOTION_PROOF.md](./M30D_FAL_MOTION_PROOF.md) | Reconciled fal Seedance proof — no new paid spend |
...
| [M30D_DIRECTOR_EDITOR_CERTIFICATION.md](./M30D_DIRECTOR_EDITOR_CERTIFICATION.md) | Director→Editor handoff sync model |
...
| [M30D_ACCESSIBILITY_CERTIFICATION.md](./M30D_ACCESSIBILITY_CERTIFICATION.md) | axe critical checks and keyboard focus — conditional |
...
| [M30D_PRODUCTION_SITUATIONS.md](./M30D_PRODUCTION_SITUATIONS.md) | S01–S12 production situation matrix |
...
- Motion: reused Seedance MP4 from M3.0c proof — **no new fal submit in M3.0d**
