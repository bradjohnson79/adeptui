...
M3.0b reported that three declared M2.11 specialists — **storyteller**, **sound-producer**, and **virtual-production-coordinator (VPC)** — never ran in the default pipeline, producing KeyError failures across situation runs.
...
| `test_m214_unified_experience.py` — storyteller/sound-producer in specialists list | PASSED |
...
- `artifacts/m30-situations/phase18-final-validation.json` — all 12 situations completed intelligence + production phases with HTTP 200 director status.
- `docs/m3.0c/PRODUCTION_SITUATION_CERTIFICATION_MATRIX.md` — S01–S12 EXECUTED.

## Status

**B8: Closed** at commit `43a5c0f0152a39327e87b10de11fd55e5b16ad90`.

## Residual (B15/B16 — related, not B8)
