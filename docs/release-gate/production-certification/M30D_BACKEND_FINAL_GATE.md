...
| Passed tests | ≥ prior baseline | 631 | **PASS** |
| PY01–PY20 original list | All closed | All closed | **PASS** |
...
The six skipped tests are live-provider or environment-inverse cases documented in `M30D_PLAYWRIGHT_CERTIFICATION.md` and the master register (PW-S4–S6 analogues in pytest). They do not represent silent passes of broken behavior.
...
| M3.0c full suite | 622 passed, 2 failed → fixed |
| **M3.0d full suite** | **631 passed, 0 failed** |

## Certification statement

The studio-api test suite at `43a5c0f0152a39327e87b10de11fd55e5b16ad90` satisfies the M3.0d backend final gate. Backend code paths for B9, B13, B19, unified jobs, export director_json, and Director→Editor handoff are covered by passing tests.
